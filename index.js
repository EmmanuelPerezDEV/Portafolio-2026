   const projectCards = document.querySelectorAll('.project-card');
    ...
    const translations = {
      en: {
        ...
        project3Title: 'Future Project', project3Text: 'Replace this card with another project such as Oceanify, a CRUD system, a REST API app, or a QA automation project using Selenium.',
      ...
      es: {
        ...
        project3Title: 'Proyecto futuro', project3Text: 'Reemplaza esta card con otro proyecto como Oceanify, un sistema CRUD, una app con API REST o un proyecto de automatización QA con Selenium.',
